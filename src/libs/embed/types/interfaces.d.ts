...
export declare const UPBOND_BUILD_ENV: {
    readonly PRODUCTION: "production";
    readonly STAGING: "staging";
    readonly DEVELOPMENT: "development";
    readonly TESTING: "testing";
    readonly LOCAL: "local";
    readonly V1_DEBUG: "v1_debug";
    readonly V1_LOCAL: "v1_local";
    readonly V1_DEVELOPMENT: "v1_development";
    readonly V1_STAGING: "v1_staging";
    readonly V1_PRODUCTION: "v1_production";
    readonly V2_DEBUG: "v2_debug";
    readonly V2_LOCAL: "v2_local";
    readonly V2_DEVELOPMENT: "v2_development";
    readonly V2_STAGING: "v2_staging";
    readonly V2_PRODUCTION: "v2_production";
    readonly DEBUG: "debug";
    readonly WALLET_DID: "wallet-did";
    readonly MPC_DEV: "mpc-dev";
};
export type BuildEnv = "production" | "staging" | "development" | "testing" | "local" | "v1_production" | "v1_development" | "v1_staging" | "v1_local" | "v1_debug" | "v2_production" | "v2_development" | "v2_staging" | "v2_local" | "v2_debug" | "debug" | "wallet-did" | "mpc-dev";
...
export type ETHEREUM_NETWORK_TYPE = "ropsten" | "rinkeby" | "kovan" | "mainnet" | "goerli" | "localhost" | "matic" | "mumbai" | "xdai" | "bsc_mainnet" | "bsc_testnet";
