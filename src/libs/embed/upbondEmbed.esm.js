...
import { setAPIKey, get } from '@toruslabs/http-helpers';
...
class Consent {
  constructor(_ref) {
    ...
    _defineProperty(this, "consentConfigurations", void 0);
    _defineProperty(this, "flowConfig", void 0);
    _defineProperty(this, "publicKey", void 0);
    _defineProperty(this, "isLoggedIn", void 0);
    _defineProperty(this, "didIntervalRequest", void 0);
    _defineProperty(this, "isDidDeployed", void 0);
    _defineProperty(this, "consentStreamName", void 0);
    _defineProperty(this, "didCreationCb", void 0);
    if (publicKey) {
  ...
  listenDidCreation() {
    ...
    stream.write({
      name: configuration.DID_STREAM_NAME.REQUEST,
      data: {
        interval: this.didIntervalRequest
      }
    });
    stream.on("data", ev => {
      if (ev.name && ev.name === configuration.DID_STREAM_NAME.RESULT) {
        if (ev.data) {
          this.isDidDeployed = true;
        } else {
          this.isDidDeployed = false;
...
class UpbondInpageProvider extends SafeEventEmitter {
  ...
  constructor(connectionStream) {
    ...
    _defineProperty(this, "isUpbond", void 0);
    ...
    // private state
    this._state = _objectSpread$1({}, UpbondInpageProvider._defaultState);
    // public state
...
_defineProperty(UpbondInpageProvider, "_defaultState", {
  accounts: null,
  isConnected: false,
  isUnlocked: false,
  initialized: false,
...
class Upbond {
  constructor() {
    ...
    _defineProperty(this, "upbondIframe", void 0);
    _defineProperty(this, "skipDialog", void 0);
    ...
    _defineProperty(this, "provider", void 0);
    _defineProperty(this, "communicationMux", void 0);
    _defineProperty(this, "isUsingDirect", void 0);
    _defineProperty(this, "isLoginCallback", void 0);
    _defineProperty(this, "dappRedirectUrl", void 0);
    _defineProperty(this, "paymentProviders", configuration.paymentProviders);
    _defineProperty(this, "selectedVerifier", void 0);
    _defineProperty(this, "buildEnv", void 0);
    _defineProperty(this, "widgetConfig", void 0);
  ...
  async init() {
    ...
    const {
      torusUrl,
      logLevel
    } = await getUpbondWalletUrl(buildEnv);
...
export { BUTTON_POSITION, LOGIN_PROVIDER, PAYMENT_PROVIDER, SUPPORTED_PAYMENT_NETWORK, UPBOND_BUILD_ENV, UpbondInpageProvider, WALLET_OPENLOGIN_VERIFIER_MAP, WALLET_VERIFIERS, Upbond as default };
//# sourceMappingURL=upbondEmbed.esm.js.map
